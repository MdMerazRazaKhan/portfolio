              ...
              {selectedEdu.studentId && (
                <div className="modal-info-item">
                  ...
                  <div className="info-text">
                    ...
                    <span className="info-value">{selectedEdu.studentId}</span>
                  </div>
                </div>
              )}
              {selectedEdu.universityId && (
                <div className="modal-info-item">
                  <div className="info-icon" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", color: "var(--accent)" }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className="info-text">
                    ...
                    <span className="info-value">{selectedEdu.universityId}</span>
                  </div>
                </div>
              )}
            </div>
